...
def main():
    ...
    ocsp_cert_parser.add_argument('--san', action='append', help='Subject Alternative Name (e.g., dns:ocsp.example.com)')
    ...
    serve_ocsp_parser.add_argument('--responder-cert', required=True, help='OCSP responder certificate (PEM)')
    serve_ocsp_parser.add_argument('--responder-key', required=True, help='OCSP responder private key (unencrypted PEM)')
    serve_ocsp_parser.add_argument('--ca-cert', required=True, help='Issuer CA certificate')
    serve_ocsp_parser.add_argument('--cache-ttl', type=int, default=60, help='Cache TTL in seconds')
