...
def start_repo_server(host, port, db_path, cert_dir, log_file=None):
    ...
    # Преобразуем относительные пути в абсолютные относительно текущей рабочей директории
    ...
    def request_cert():
        ...
        args.ca_pass_file = str(
            intermediate_pass_file) if intermediate_pass_file and intermediate_pass_file.exists() else None
